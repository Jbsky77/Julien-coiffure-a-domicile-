  ...
  return (
    <main className="min-h-screen overflow-hidden bg-[#f6f7fb] text-slate-900">
      ...
      <section className="mx-auto max-w-7xl px-5 pb-20">
        <div className="mb-8 flex flex-col justify-between gap-4 md:flex-row md:items-end"><div><p className="text-xs font-extrabold tracking-[.18em] text-[#ab760e]">SUR LE TERRAIN</p><h2 className="mt-3 text-3xl font-black tracking-[-.04em] md:text-4xl">Conçu pour votre vraie journée de coiffeur à domicile.</h2></div><p className="max-w-md leading-7 text-slate-600">Du premier rendez-vous au dernier trajet, l’application vous accompagne là où vous travaillez.</p></div>
        <div className="grid gap-5 md:grid-cols-3">
          <article className="overflow-hidden rounded-[1.8rem] bg-white shadow-lg shadow-slate-900/10"><img loading="lazy" src="https://images.unsplash.com/photo-1522337360788-8b13dee7a37e?auto=format&fit=crop&w=900&q=85" alt="Prestation coiffure à domicile" className="h-56 w-full object-cover" /><div className="p-5"><h3 className="font-extrabold">Chez vos clientes</h3><p className="mt-2 text-sm leading-6 text-slate-600">Toutes les informations utiles sont disponibles en quelques secondes.</p></div></article>
          <article className="overflow-hidden rounded-[1.8rem] bg-white shadow-lg shadow-slate-900/10"><img loading="lazy" src="https://images.unsplash.com/photo-1521590832167-7bcbfaa6381f?auto=format&fit=crop&w=900&q=85" alt="Coiffeuse préparant une coiffure professionnelle" className="h-56 w-full object-cover" /><div className="p-5"><h3 className="font-extrabold">Votre expertise mise en valeur</h3><p className="mt-2 text-sm leading-6 text-slate-600">Des rendez-vous, une fidélité et une relation client à votre image.</p></div></article>
          <article className="overflow-hidden rounded-[1.8rem] bg-white shadow-lg shadow-slate-900/10"><img loading="lazy" src="https://images.unsplash.com/photo-1487412912498-0447578fcca8?auto=format&fit=crop&w=900&q=85" alt="Matériel et produits de coiffure professionnels" className="h-56 w-full object-cover" /><div className="p-5"><h3 className="font-extrabold">Un salon bien piloté</h3><p className="mt-2 text-sm leading-6 text-slate-600">Stock, encaissements, tournées et statistiques enfin réunis.</p></div></article>
        </div>
      </section>
